...
export const Icons = {
  logo: (props: SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 60 60">
      <path
        d="M45.2,3.2H14.8C8.3,3.2,3.2,8.3,3.2,14.8v18c0,6.5,5.1,11.6,11.6,11.6h2.1v8.3c0,1.9,2.3,2.9,3.8,1.7l9.3-7.4c1.1-0.9,2.5-1.4,4-1.4h11c6.5,0,11.6-5.1,11.6-11.6v-18C56.8,8.3,51.7,3.2,45.2,3.2z"
        fill="currentColor"
      />
      <g transform="translate(18, 18) scale(0.5)">
        <path
          d="M29.8,13.3h-8.1V5.1c0-1.4-1.1-2.5-2.5-2.5s-2.5,1.1-2.5,2.5v8.1h-8.1c-1.4,0-2.5,1.1-2.5,2.5s1.1,2.5,2.5,2.5h8.1v8.1c0,1.4,1.1,2.5,2.5,2.5s2.5-1.1,2.5-2.5v-8.1h8.1c1.4,0,2.5-1.1,2.5-2.5S31.2,13.3,29.8,13.3z"
          fill="#FFFFFF"
        />
      </g>
    </svg>
